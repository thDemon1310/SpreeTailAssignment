...
8. **Missing paid_by / missing currency** — reject the row into a "needs manual resolution" queue, do not guess. This directly satisfies Meera's request ("I want to approve anything the app deletes or changes").
